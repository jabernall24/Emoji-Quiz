...
class WorldCup2014Quiz: UIViewController, UITextFieldDelegate{
    ...
    let allQuestions = WorldCup2014Emoji()
    var pickedAnswer = ""
    var lvlNumber = 0
    var score = 0
    let scoreLabel = WorldCup2014ScoreLabel().scoreLabel()
    let lvlEmoji = WorldCup2014LevelEmoji().lvlEmoji()
    ...
    let previousAnswerLabel = WorldCup2014PreviousAnswerLabel().previousAnswerLabel()
    var previousEmoji = ""
    ...
    func nextQuestion(){
        ...
        if lvlNumber < numberOfQuestions{
            ...
            if score > defaults.integer(forKey: "brazil2014HighScore"){
                highscore = score
                defaults.set(highscore, forKey: "brazil2014HighScore")
